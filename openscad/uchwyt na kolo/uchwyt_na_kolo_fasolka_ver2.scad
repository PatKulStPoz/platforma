...
union(){
    difference(){
        cube([nakladka_dl, nakladka_sz, nakladka_h], center=true);
                   ...
                   rotate([35,0,0]){
        translate([0,25,-2.5]){
            #cube([nakladka_dl+30, 10, 40],center = true);
        }}
    ...
    difference(){
    translate([0,nakladka_sz/2-mocowanie_gr/2-mocowanie_gr,nakladka_h/2+5]){
        cube([mocowanie_dl,mocowanie_gr+2,10], center = true);}
        
                           rotate([35,0,0]){
        translate([0,25,-2.5]){
            #cube([nakladka_dl+30, 10, 50],center = true);
        }}
    }

    translate([0,nakladka_sz/2-mocowanie_gr/2-mocowanie_gr*2,nakladka_h/2+mocowanie_h/2]){
        ...
        rotate([50,0,0]){
        translate([0,3.5,14.2]){
            #cube([nakladka_dl+30, rama_sr, rama_sr],center = true);
        }}
