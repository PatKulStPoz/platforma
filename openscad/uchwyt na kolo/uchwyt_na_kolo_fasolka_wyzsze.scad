...
union(){
    difference(){
        ...
        rotate([0,0,0]){
        translate([0,-mocowanie_gr/2,dno_grubosc+rama_sr/2]){
            #cube([nakladka_dl+30, rama_sr-mocowanie_gr, nakladka_h],center = true);
        }}
        
        rotate([37,0,0]){
        translate([0,-mocowanie_gr/2+3+0.2,dno_grubosc+rama_sr/2-3.5]){
            #cube([nakladka_dl+30, rama_sr-mocowanie_gr+0.7, nakladka_h],center = true);
        }}
    ...
    translate([0,nakladka_sz/2-mocowanie_gr/2-mocowanie_gr,nakladka_h/2+mocowanie_h/2]){
        mocowanie(mocowanie_h, mocowanie_sr1, mocowanie_gr, mocowanie_dl, 6.25);
    }
    translate([0,nakladka_sz/2-mocowanie_gr/2,nakladka_h/2+5]){
        cube([mocowanie_dl, mocowanie_gr, 30], center=true);
    }
